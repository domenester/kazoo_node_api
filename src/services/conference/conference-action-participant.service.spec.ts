...
import { ConferenceActionParticipantService } from "./conference-action-participant.service";
import { userMock, userMock2 } from "../user/mocks";

describe("Testing Conference Action Participant Service", async () => {
  ...
  it("should create a new conference action for a participant", async () => {
    const response = await ConferenceActionParticipantService(
